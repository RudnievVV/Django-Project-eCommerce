# Generated by Django 3.0.7 on 2020-08-18 22:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('root_category', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('parent_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_categories', to='ecommerce.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_short', models.TextField(blank=True, max_length=100)),
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('main_image', models.ImageField(default='\\img\\product\\placeholder.jpg', upload_to=ecommerce.models.product_main_image_directory_path)),
                ('type', models.CharField(max_length=20, verbose_name='Simple')),
        ...
        migrations.CreateModel(
            name='SimpleProductAdditionalImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='\\img\\product\\placeholder.jpg', upload_to=ecommerce.models.product_additional_image_directory_path)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='ecommerce.SimpleProduct')),
            ],
        ),
    ]
